...
class test_node_based_access(unittest.TestCase):
    ...
    def test_root(self):
        ...
        expected_children = ['augments', 'bronze', 'cli', 'container1', 'container_and_lists', 'default', 'diff', 'dirty_secret', 'empty',
                             'hyphen_leaf', 'imports_in_here', 'list_to_leafref_against', 'lista', 'listgroup1', 'morecomplex',
